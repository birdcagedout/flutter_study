// Key를 사용하지 않은 위젯을 식별하는데 문제가 발생하는지 Test4
// - 조건: Stateful 위젯 + 같은 클래스 + key 사용 함!!
// - 결과: 클래스 타입이 같으면 key를 사용해야 ==> 위젯 식별에 문제 없다.(식별할 수 있다.)
...
class _MyColorListWidgetState extends State<MyColorListWidget> {
  List<Widget> widgetList = [
    ...
    MyCOLORItemWidget(Colors.green, key: UniqueKey(),),
  ];
