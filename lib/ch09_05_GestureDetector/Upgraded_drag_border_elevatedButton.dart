...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
          appBar: AppBar(title: Text("GestureDetector ElevatedButton 연습")),
          body: Column(
            children: [
              GestureDetectorPart(),      // 윗부분: GestureDetector 구현
              ElevatedButtonPart(),       // 밑부분: ElevatedButton 구현
            ],
          ),
        )
    );
...
// 윗부분 (GestureDetector 구현)
class GestureDetectorPart extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => _GestureDetectorPartState();
}

class _GestureDetectorPartState extends State<GestureDetectorPart> {
...
// 밑부분 (ElevatedButton 3개 구현)
class ElevatedButtonPart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
